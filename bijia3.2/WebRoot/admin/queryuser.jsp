          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE4"><span class="STYLE3">您当前的位置是</span>：[查看用户资料]</td>
              </tr>
            </table></td>
...
<table align="center" border="1">
	<tr><th>编号</th><th>姓名</th><th>密码</th><th>性别</th><th>上次登录时间</th><th>上次登录IP</th><th>联系电话</th></tr>
<%--
int page1=0;
...
for(User a:list){ 
	--%>
	<%-- <tr><th><%=a.getUid() %></th><th><%=a.getUname() %></th><th><%=a.getUpwd() %></th><th><%=a.getSex() %></th><th><%=a.getDate() %></th><th><%=a.getIp()%></th><th><%=a.getTel() %></th></tr> --%>
	<%--
}
--%>
<%-- <tr><th>共<%=pageModel.getTotalPages()%>页</th><th>当前第<%=pageModel.getPageNo() %>页</th><th><a href="queryuser.jsp?page1=<%=pageModel.getTopPageNo()%>">首页 </a></th><th><a href="queryuser.jsp?page1=<%=pageModel.getPreviousPageNo()%>">上一页 </a></th><th><a href="queryuser.jsp?page1=<%=pageModel.getNextPageNo()%>">下一页 </a></th><th><a href="queryuser.jsp?page1=<%=pageModel.getBottomPageNo() %>">尾页</a></th><th>共条<%=pageModel.getTotalRecords() %>记录</th> </tr> --%>
</table>
</body>
</html>